...
public class PlayerBullet : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision) {
        ...
        if(collided.tag.StartsWith("Bullet") || collided.CompareTag("Player") || collided.gameObject.name == "Global Light Trigger" || collided.gameObject.name == "Maze Trigger" || collided.gameObject.name == "Laser Puzzle Trigger" || collided.gameObject.name == "Boss Battle") {
            return;
        }
